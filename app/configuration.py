...
VALVES_FLOW = [ [2,4], [3,4], [1,5], [1,4] ]											# LIST OF VALVE INDICES TO OPEN PER FLOW CIRCUIT [CIRUIT][VALVES]
NR_FLOW = len(NAMES_FLOW)																# NR OF FLOW CIRCUITS

# PWM DRIVEN LIGHTS
#NAMES_LAMP = 	[ "LED0", 	"LED1" ]													# DISPLAY NAME OF LAMP UNITS
#CHANNELS_LAMP = [ ['R','G','B','W'],	['R','G','B'] ]									# RGBW CHANNEL FOR EACH LAMP MODULE 	-> 2D-array [lamp][channel]
NAMES_LAMP = 	[ "LED0" ]													# DISPLAY NAME OF LAMP UNITS
CHANNELS_LAMP = [ ['W'] ]									# RGBW CHANNEL FOR EACH LAMP MODULE 	-> 2D-array [lamp][channel]

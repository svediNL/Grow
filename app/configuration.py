...
# THERMOCOUPLES
NAMES_THERMO 	= ["TC0", "TC1"]		# DISPLAY NAMES OF THERMOCOUPLES ->	example: NAMES_THERMO = ["ground temperature", "air temperature"]
UNITS_THERMO	= "[deg. C]"			# MEASURED UNITS OF THERMOCOUPLE
NR_THERMO 		= len(NAMES_THERMO)		# NR OF THERMOCOUPLES	(CALCULATED)


# LED DRIVER (PWM)					
NAMES_LAMP 		= [ "LED0" ]		# DISPLAY NAME OF LAMP UNITS ->	example: NAMES_LAMP = ["my RGBW Lamp", "my Simple Lamp"]													
...
# MOISTURE SENSORS
NAMES_MOISTURE 	= ["SOIL0"]				# DISPLAY NAMES OF ANALOG RESISTIVE MOISTURE SENSORS ->	example: NAMES_MOISTURE = ["moisture small pot", "moisture big pot"]
NR_MOISTURE 	= len(NAMES_MOISTURE)	# NR OF ANALOG RESISTIVE MOISTURE SENSORS (CALCULATED)

# H-BRIDGE BASED PUMP (PWM, DIRECTION)
NAMES_PUMP	= ["PUMP0"]			# PUMP DISPLAY NAMES -> ONLY ONE IS SUPPORTED ATM
